...
- [Quickstart](/openai/quickstart/) sets environment variables and makes the first Responses API call.
- [Configuration](/openai/configuration/) explains how to keep keys, domains, and model names replaceable.
- [Models](/openai/models/) lists currently applicable model names and their `pa/` mapping.
- [Curl examples](/openai/curl-examples/) provides copyable calls for common support cases.
- [GPT reasoning](/openai/reasoning/) covers effort, token budgeting, summaries, prompting, tools, and FAQ.
